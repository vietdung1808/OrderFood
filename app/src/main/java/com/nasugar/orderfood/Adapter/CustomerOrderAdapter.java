...
/**
 * Created by Oai.BuiQuoc on 9/10/2020.
 */
public class CustomerOrderAdapter extends RecyclerView.Adapter<CustomerOrderAdapter.CardHolder>{
    ...
    public CustomerOrderAdapter(Context mContext, List<Cart> mCartList) {
    ...
    @NonNull
    @Override
    public CustomerOrderAdapter.CardHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate( R.layout.customer_row_order, parent, false);
        return new CustomerOrderAdapter.CardHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerOrderAdapter.CardHolder holder, int position) {
